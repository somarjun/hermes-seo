...
hermes-seo is mirrored across two GitHub remotes. This document is the
...
```
  ...
  somarjun/hermes-seo      AI-Marketing-Hub/hermes-seo
...
|---|---|---|
| `.claude-plugin/marketplace.json` `name` | `ai-marketing-hub-hermes-seo` | `agricidaniel-hermes-seo` |
...
install block defaults to `somarjun/hermes-seo`, with a Pro swap-note that
