...
Hermes SEO follows Anthropic's official Hermes Agent skill specification with a modular, multi-skill architecture.
...
6. Merges MCP config into `~/.hermes/config.yaml` non-destructively
