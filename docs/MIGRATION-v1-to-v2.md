# Migrating from hermes-seo v1.x to v2.0.0
...
| `extensions/ahrefs/` | Official `@ahrefs/mcp` server wired into Hermes Agent |
...
`~/.config/hermes-seo/oauth-token.json`, v2 will silently re-chmod it
