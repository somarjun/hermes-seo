...
Config: ~/.config/hermes-seo/dataforseo-costs.json
Ledger: ~/.config/hermes-seo/dataforseo-ledger.json
...
Security fixes: config path corrected to ~/.config/hermes-seo/
"""
...
# ----- paths -----
CONFIG_DIR = Path.home() / ".config" / "hermes-seo"
