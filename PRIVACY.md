...
Hermes SEO is a Hermes Agent skill that runs entirely on your local machine. The core skill does not collect, transmit, or store any personal data.

## What Stays Local

- All SEO analysis runs in your Hermes Agent session
...
- API keys and OAuth tokens are stored locally in `~/.config/hermes-seo/` or environment variables
