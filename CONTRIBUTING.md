# Contributing to hermes-seo

Thanks for your interest in contributing! Here's how to get involved.

## Reporting Bugs

Open a [GitHub Issue](https://github.com/somarjun/hermes-seo/issues) with:
...
Use [GitHub Discussions](https://github.com/somarjun/hermes-seo/discussions) for feature ideas and questions.
...
```bash
git clone https://github.com/YOUR_USERNAME/hermes-seo.git
cd hermes-seo
bash install.sh
```
...
- All Python scripts should output JSON for Hermes Agent to parse
...
Hermes SEO accepts community-built extensions through challenges and PRs.
