...
ranking or citation lever in any hermes-seo report.
...
Continue, Cline, Hermes Agent) when loading per-library documentation.
...
## How hermes-seo treats `llms.txt`
...
- If the user asks to generate one, hermes-seo produces a minimal valid
