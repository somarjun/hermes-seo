<!-- hermes-delegate -->
Use with `delegate_task`: pass this file's instructions as the `goal` and the audit URL/context as `context`. Toolsets: `["terminal", "file", "web"]`.
...
4. Format output to match hermes-seo conventions (tables, priority levels, scores)
...
Match existing hermes-seo patterns:
