...
```
~/.cache/hermes-seo/drift/baselines.db
```
...
**Execution:**
```bash
python ${HERMES_SKILL_DIR}/scripts/drift_baseline.py <url>
python ${HERMES_SKILL_DIR}/scripts/drift_baseline.py <url> --skip-cwv
```
...
**Execution:**
```bash
python ${HERMES_SKILL_DIR}/scripts/drift_compare.py <url>
python ${HERMES_SKILL_DIR}/scripts/drift_compare.py <url> --baseline-id 5
python ${HERMES_SKILL_DIR}/scripts/drift_compare.py <url> --skip-cwv
```
...
```bash
python ${HERMES_SKILL_DIR}/scripts/drift_report.py <comparison_json_file> --output drift-report.html
```
...
**Execution:**
```bash
python ${HERMES_SKILL_DIR}/scripts/drift_history.py <url>
python ${HERMES_SKILL_DIR}/scripts/drift_history.py <url> --limit 10
```
