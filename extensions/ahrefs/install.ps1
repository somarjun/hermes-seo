# Hermes SEO — Ahrefs extension installer (Windows / PowerShell).
...
if (-not (Test-Path (Join-Path $SkillDir "seo"))) {
    throw "hermes-seo base plugin not installed."
}
...
Write-Host ""
Write-Host "Done. Open a new Hermes Agent session and run /seo ahrefs metrics <url>."
