#!/usr/bin/env bash
# Hermes SEO — Ahrefs extension installer.
#
# Wires the official @ahrefs/mcp server into ~/.hermes/config.yaml and
# copies the seo-ahrefs mirror skill into ~/.hermes/skills/.
#
...
main() {
    ...
    echo "════════════════════════════════════════"
    echo "║   Hermes SEO — Ahrefs extension      ║"
    echo "════════════════════════════════════════"
    ...
    if [ ! -d "${SKILL_DIR}/seo" ]; then
        echo "✗ hermes-seo base plugin not installed."
    ...
    # Merge MCP config into ~/.hermes/config.yaml atomically.
...
PY
    ...
    echo
    echo "Done. Open a new Hermes Agent session and run:"
