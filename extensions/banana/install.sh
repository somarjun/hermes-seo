...
# Banana Image Generation Extension Installer for Hermes SEO
# Wraps everything in main() to prevent partial execution on network failure

main() {
    SKILL_DIR="${HOME}/.hermes/skills/seo-image-gen"
    ...
    if [ -f "${SCRIPT_DIR}/skills/seo-image-gen/SKILL.md" ]; then
        ...
        echo "  Run this script from the hermes-seo repo: ./extensions/banana/install.sh"
        exit 1
    fi
