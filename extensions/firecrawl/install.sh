...
# Firecrawl Extension Installer for Hermes SEO
# Wraps everything in main() to prevent partial execution on network failure

main() {
    SKILL_DIR="${HOME}/.hermes/skills/seo-firecrawl"
    ...
    if [ -f "${SCRIPT_DIR}/skills/seo-firecrawl/SKILL.md" ]; then
        ...
        echo "  Run this script from the hermes-seo repo: ./extensions/firecrawl/install.sh"
        exit 1
    fi
...
" || {
        ...
        echo "  Add the firecrawl-mcp server manually to ~/.hermes/config.yaml"
