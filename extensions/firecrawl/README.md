# Firecrawl Extension for Hermes SEO
...
When installed, other Hermes SEO skills automatically leverage Firecrawl:
...
**MCP not connecting?**
- Check: `cat ~/.hermes/config.yaml | python3 -m json.tool | grep firecrawl`
