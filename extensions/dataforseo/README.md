# DataForSEO Extension for Hermes SEO
...
- [Hermes SEO](https://github.com/somarjun/hermes-seo) installed
- Node.js 20+
...
3. Configure the MCP server in `~/.hermes/config.yaml`
...
## Integration with Hermes SEO

When installed, other Hermes SEO skills automatically detect DataForSEO availability and use live data:
...
1. Check credentials: `cat ~/.hermes/config.yaml | grep DATAFORSEO`
...
- [Hermes SEO](https://github.com/somarjun/hermes-seo)
