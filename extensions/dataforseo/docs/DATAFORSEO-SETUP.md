...
Step-by-step guide to getting DataForSEO API credentials for the Hermes SEO extension.
...
If the installer's auto-configuration fails, add this to `~/.hermes/config.yaml`:
...
After installing, start Hermes Agent and run:
