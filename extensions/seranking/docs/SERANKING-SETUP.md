...
`SKILL.md` into `~/.hermes/skills/seo-seranking/`, and writes
`env.SERANKING_API_KEY` into `~/.hermes/config.yaml` with mode 0o600.
...
```
/seo seranking ai-visibility "Hermes SEO"
```
